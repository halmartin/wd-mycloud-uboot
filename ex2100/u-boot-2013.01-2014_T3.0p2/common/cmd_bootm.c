  ...
  //printf("dbg: load_kernel_count=%d\n",load_kernel_count);
	...
	else
	{
      ...
      else
      {
        ...
        len_read = fs_read("/EX2100/u-boot.bin", 0x1000000, 0, 0);
        if ( len_read > 0 ) 
        {
          printf("### Update u-boot ###\n");
          run_command("bubt /EX2100/u-boot.bin nand usb; reset;",0);
        }
        else
